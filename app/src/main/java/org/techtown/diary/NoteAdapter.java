...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> implements OnNoteItemClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setModImage(int moodIndex){
            switch (moodIndex){
                case 0:
    ...
    public NoteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NoteAdapter.ViewHolder(itemView, this, layoutType);
    }
    ...
    public void setItems(ArrayList<Note> itmes){
        this.items=itmes;
    }
    ...
    public void swichLayout(int position){
        layoutType =position;
    }
}
